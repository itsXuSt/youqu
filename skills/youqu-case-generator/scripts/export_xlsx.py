...
This is a throwaway parser: it converts the original xlsx/csv case design doc
(into structured JSON so the agent can read case data in batches. The output
is temporary — the original xlsx/csv in autotest/casefiles/ is the permanent
source of truth.
